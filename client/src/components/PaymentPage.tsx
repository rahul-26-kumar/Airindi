...
const PaymentPage: React.FC<PaymentPageProps> = ({ 
  ...
  return (
    <div className="payment-container p-6 bg-white rounded-lg shadow-lg">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <div className="card-details border border-neutral-200 rounded-lg p-4">
          ...
          <div className="billing-address border border-neutral-200 rounded-lg p-4">
